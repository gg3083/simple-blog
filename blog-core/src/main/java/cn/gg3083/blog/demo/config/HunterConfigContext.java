package cn.gg3083.blog.demo.config;
...
public class HunterConfigContext {
     ...
     * @return HunterConfig
     */
    public static me.zhyd.hunter.config.HunterConfig getHunterConfig(String url) {
     ...
     * @return HunterConfig
     */
    public static me.zhyd.hunter.config.HunterConfig getHunterConfig(Platform platform) {
        ...
        return JSONObject.toJavaObject(platformObj, me.zhyd.hunter.config.HunterConfig.class);
    }
     ...
     * @return config
     */
    public static me.zhyd.hunter.config.HunterConfig parseConfig(HunterConfig config) {
        if (null == config) {
            return null;
        }
